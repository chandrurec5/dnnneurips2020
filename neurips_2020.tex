...
We consider networks with $d$ layers, and $w$ hidden neurons per layer. Central to the contributions in this paper is the conceptual novelty of regarding activations/gates and paths as basic building blocks of a DNNs. %We now describe in brief the conceptual novelties (CN), the corresponding conceptual gains/insights (CG) and the key results in the paper.
